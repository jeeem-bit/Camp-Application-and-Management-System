...
public class Enquiry {
	/**
	 * user of the student that made This enquiry
	 */
    ...
    /**
     * true or false, depending on if the enquiry has been processed
     */
    private boolean processed;
    /**
     * The reply the staff has given to the enquiry
     */
    private String replyStringStaff;
    /**
     * The reply the committee has given to the enquiry
     */
     ...
     * @param enquiryString The enquiry being made 
     */
